...
int main(int argc, const char **argv)
{
	...
	auto runAfterConnection = [&ws,&createSign,&web_api_key,&secret,&web_api_id](void) ->void {
		...
		// send login command
		(void) ws["fxopen_feed"].write(message.str());
		(void) ws["fxopen_feed"].write("{\"Id\": \"A03DF33D-E520-483B-892F-73C671127BC2\",\"Request\": \"FeedSubscribe\",\"Params\": {\"Subscribe\": [{\"Symbol\": \"EURUSD\",\"BookDepth\": 3}, {\"Symbol\": \"USDJPY\",\"BookDepth\": 1}]}}");
	};
	ws.addProtocol("fxopen_feed","marginalttlivewebapi.fxopen.net","/",3000, false,func);
